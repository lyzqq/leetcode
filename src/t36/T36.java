 ...
 * ,[".",".",".",".","8",".",".","7","9"]]
 * 输出：false
 * 解释：除了第一行的第一个数字从 5 改为 8 以外，空格内其他数字均与 示例1
 * 相同。 但由于位于左上角的 3x3 宫内有两个 8 存在, 因此这个数独是无效的。
 */
public class T36 {
...
//                    else { sbox[index_box][num]=1; }
                    if (rows[i][num] == 1 || col[j][num] == 1 || sbox[index_box][num] == 1) {
                        return false;
                    } else {
                        rows[i][num] = 1;
                        col[j][num] = 1;
    ...
    public static void main(String[] args) {
        ...
        char[][] board = {
                ...
                {'.', '.', '.', '4', '1', '9', '.', '.', '5'},
                {'.', '.', '.', '.', '8', '.', '.', '7', '9'}};
        System.out.println(t36.isValidSudoku(board));
    }
}
