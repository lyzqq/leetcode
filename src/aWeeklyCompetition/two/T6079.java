...
public class T6079 {
    ...
    public static String discountPrices(String sentence, int discount) {
        ...
        double count = (100 - discount) / 100.00;
        StringBuilder res = new StringBuilder();
        for (String string : strings) {
            if (string.length() > 1 && string.charAt(0) == '$' && (string.charAt(1) <= '9' && string.charAt(1) >= '1')) {
                ...
                if (tem == string.length() - 1) {
                    string = String.format("%.2f", Double.parseDouble(sb.toString()) * count);
    ...
    public static void main(String[] args) {
        String sentence = "there are $1 $2 and 5$ candies in the $10%";
        int discount = 50;
